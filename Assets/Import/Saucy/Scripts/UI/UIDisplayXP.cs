...
namespace Saucy.Modules.XP {
  public class UIDisplayXP : MonoBehaviour {
    ...
    [Space] [SerializeField] private Text xpMethodName;

    // UI Text references.
    [SerializeField] private Text currentXP;
    [SerializeField] private Text maxXP;
    [SerializeField] private Text acquiredXP;
    [SerializeField] private Text requiredXP;
    [SerializeField] private Text previouslyRequiredXP;
    [SerializeField] private Text level;
    [SerializeField] private Text maxLevel;
    [SerializeField] private Text maxLevelReached; // Text to display max level being reached.

    // We're using a sliders because it can easily show progress by just setting the value of the slider (values 0-1).
    [SerializeField] private Slider progress; // Level progress.
    [SerializeField] private Slider progressOverall; // Overall level progress (starting level -> max level).

    // Prefab or a list "row" we can instantiate and set the text to values that we have in playerSavedXP.
    [Space] [SerializeField] private GameObject listPrefab;
    // The container where to instantiate the listPrefab at.
    [SerializeField] private GameObject listContainer;
    // Colors for the "row". So we more easily can see them.
    [SerializeField] private Color listBackgroundColorEven;
    [SerializeField] private Color listBackgroundColorOdd;

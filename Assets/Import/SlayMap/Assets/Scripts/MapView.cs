...
public class MapView : MonoBehaviour
{
    ...
    private void SetOrientation()
    {
        ...
        var offsetZ = 80f; //The last knight

        // setting first parent to be right in front of the camera first:
        firstParent.transform.position = new Vector3(cam.transform.position.x, cam.transform.position.y, offsetZ);

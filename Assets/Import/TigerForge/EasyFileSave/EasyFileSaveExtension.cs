...
public class EasyFileSaveExtension
{
    ...
    void Map()
    {
        ...
        SetParameters(
            "Map",
            new Par { name = "bossNodeName", value = mapa.bossNodeName},
            new Par { name = "configName", value = mapa.configName},
            new Par { name = "path", value = mapa.path},
            new Par { name = "nodes", value = mapa.nodes }
            );
    }
